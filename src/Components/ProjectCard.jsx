...
const ProjectCard = ({ project }) => {
  return (
    <div className="project-card bg-gray-300 rounded-lg shadow-lg transition transform hover:scale-105 w-80  mx-auto">
      ...
      <h3 className="text-xl p-4 font-semibold mt-4 text-black">{project.title}</h3>
      ...
      <div className="mt-4 flex justify-between p-4">
        ...
        <a href={project.repoLink} className="text-blue-500 hover:underline"> <i class="fa-brands fa-github text-4xl hover:text-red-500" ></i></a>
      </div>
    </div>
  );
};
